...
labels = [(50,750,'SYNTHETIC EQUIPMENT SCHEDULE - REVIEW ONLY'),
          (50,700,'TAG'),(180,700,'DIMENSIONS IN'),(340,700,'CFM'),(450,700,'MCA'),
          (50,650,'RTU-1'),(180,650,'24 x 36 x 48'),(340,650,'1,200'),(450,650,'18'),
          (50,600,'EF-2'),(340,600,'250'),
          (50,550,'RTU-1'),(180,550,'24-36 x 48'),(340,550,'1,400'),(450,550,'20'),
...
folder=root/'Tests/LoadSightKitTests/Fixtures';(folder/'DimensionSchedule.pdf').write_bytes(data)
...
request={'schemaVersion':1,'regions':[{'sourceID':sha,'pageID':sha+':1','bodyBounds':{'x':40,'y':520,'width':480,'height':160},'columns':[
    ...
    {'field':'dimensions','minX':160,'maxX':320,'headerText':'DIMENSIONS IN','unitText':'in'},
...
(folder/'DimensionScheduleMapping.json').write_text(json.dumps(request,indent=2)+'\n')
print(sha)
