...
labels = [(50,750,'SYNTHETIC EQUIPMENT SCHEDULE - REVIEW ONLY'),
          (50,700,'TAG'),(180,700,'MANUFACTURER'),(340,700,'CFM'),(450,700,'MCA'),
          (50,650,'RTU-1'),(180,650,'Example Co'),(340,650,'1,200'),(450,650,'18'),
          (50,600,'EF-2'),(180,600,'Synthetic Inc'),(340,600,'250'),
          (50,550,'RTU-1'),(180,550,'Example Co'),(340,550,'1,400'),(450,550,'20'),
...
folder=root/'Tests/LoadSightKitTests/Fixtures';(folder/'EquipmentSchedule.pdf').write_bytes(data)
...
(folder/'EquipmentScheduleMapping.json').write_text(json.dumps(request,indent=2)+'\n')
print(sha)
