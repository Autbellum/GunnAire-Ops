...
labels = [(50,750,'SYNTHETIC EQUIPMENT SCHEDULE - REVIEW ONLY'),
          (50,700,'TAG'),(180,700,'MANUFACTURER'),(340,700,'TOTAL CFM'),(450,700,'OA CFM'),
          (50,650,'RTU-1'),(180,650,'Example Co'),(340,650,'1,200'),(450,650,'1,800'),
          (50,600,'EF-2'),(180,600,'Synthetic Inc'),(340,600,'250'),
          (50,550,'RTU-1'),(180,550,'Example Co'),(340,550,'1,400'),(450,550,'200'),
          (50,450,'PLAN TAGS: RTU-1 EF-2 AHU-9'),
          (50,420,'Counts and performance are not verified by this fixture.')]
...
folder=root/'Tests/LoadSightKitTests/Fixtures';(folder/'ConsistencySchedule.pdf').write_bytes(data)
...
request={'schemaVersion':1,'regions':[{'sourceID':sha,'pageID':sha+':1','bodyBounds':{'x':40,'y':520,'width':480,'height':160},'columns':[
    ...
    {'field':'manufacturer','minX':160,'maxX':320,'headerText':'MANUFACTURER'},
    {'field':'airflow','minX':320,'maxX':430,'headerText':'TOTAL CFM','unitText':'CFM'},
    {'field':'outdoorAir','minX':430,'maxX':520,'headerText':'OA CFM','unitText':'CFM'}],
...
(folder/'ConsistencyScheduleMapping.json').write_text(json.dumps(request,indent=2)+'\n')
print(sha)
