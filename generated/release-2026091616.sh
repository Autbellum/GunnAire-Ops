#!/bin/zsh
# Release half of the 2026091616 ship: push main (Render deploys from main) and
...
OUT=/var/folders/6t/lzhbzk216q3d5mbvsys_lbww0000gp/T/ship-2026091616

[ -d "$OUT/GunnAireOps-2026091616.xcarchive" ] || { echo "archive missing; build it first"; exit 1; }
git push origin main 2>&1 | tail -1

xcodebuild -exportArchive -archivePath "$OUT/GunnAireOps-2026091616.xcarchive" \
