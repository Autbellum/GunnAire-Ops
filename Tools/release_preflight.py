...
EXPECTED_CLOUDKIT_V25_ADDITIONS = {
    **EXPECTED_CLOUDKIT_V24_ADDITIONS,
    "CD_Item": {
        **EXPECTED_CLOUDKIT_V24_ADDITIONS["CD_Item"],
        "CD_quickBooksInventorySetupJSON": _CLOUDKIT_STRING_FIELD,
        "CD_quickBooksCatalogDetailsJSON": _CLOUDKIT_STRING_FIELD,
    },
}
...
def check_cloudkit(development: Path, production: Path, results: Results) -> None:
    try:
        ...
        for record_name, expected_fields in EXPECTED_CLOUDKIT_V25_ADDITIONS.items():
        ...
        results.require(
            ...
            "Existing Production fields through v25 match their approved definitions",
            "CloudKit Production contains malformed approved fields through v25: "
        ...
        unexpected_additions = [
            ...
            if EXPECTED_CLOUDKIT_V25_ADDITIONS.get(record, {}).get(field) != definition
        ]
        results.require(not unexpected_additions,
                        "All CloudKit additions match approved definitions through v25",
                        f"Unexpected CloudKit additions through v25: {unexpected_additions}")
        expected_remaining_v25_additions = expected_remaining(EXPECTED_CLOUDKIT_V25_ADDITIONS)
        dev_missing_v25 = missing_or_changed(dev, EXPECTED_CLOUDKIT_V25_ADDITIONS)
        ...
        if not dev_missing_v25 and actual_additions == expected_remaining_v25_additions:
            results.pass_("CloudKit Development contains the exact cumulative v25 inventory setup and provider detail schema")
        elif not dev_missing_v24 and actual_additions == expected_remaining_v24_additions:
            results.pass_("CloudKit Development contains the exact cumulative v24 Item catalog application receipt schema")
            results.warn("CloudKit v25 inventory fields are not staged; run the signed v25 bootstrap before promotion review")
        elif (
            not dev_missing_v23
            and (
            ...
            results.warn("CloudKit source v24 Item catalog receipts are not staged; run the signed v25 bootstrap before promotion review")
        elif (
            not dev_missing_v22
            and (
            ...
            results.warn(
                "CloudKit source v23 operational field closure is not staged in Development; run the signed v25 bootstrap before promotion review"
            )
        elif (
            not dev_missing_v21
            and (
            ...
            results.warn(
                "CloudKit source v22 recurring technician work-shift record and v23 operational field closure are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
        elif (
            not dev_missing_v20
            and (
            ...
            results.warn(
                "CloudKit source v21 technician time-off, v22 recurring work-shift, and v23 operational field closure are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
        elif (
            not dev_missing_v19
            and (
            ...
            results.warn(
                "CloudKit source v20 team task, v21 technician time-off, v22 recurring work-shift, and v23 operational field closure are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
        elif (
            not dev_missing_v18
            and (
            ...
            results.warn(
                "CloudKit source v19 operational alert, v20 task, v21 technician time-off, v22 recurring work-shift, and v23 operational field closure are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
        elif (
            not dev_missing_v17
            and (
            ...
            results.warn(
                "CloudKit source v18 expense, v19 operational alert, v20 task, v21 technician time-off, v22 recurring work-shift, and v23 operational field closure are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
        elif (
            not dev_missing_v16
            and (
            ...
            results.warn(
                "CloudKit source v17 fleet, v18 expense, v19 operational alert, v20 task, v21 technician time-off, v22 recurring work-shift, and v23 operational field closure are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
            ...
            results.warn(
                "CloudKit source additions through v23 are not staged in Development; run the signed v25 bootstrap before promotion review"
            )
