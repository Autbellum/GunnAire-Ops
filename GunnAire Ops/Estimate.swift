...
final class Estimate {
    ...
    init(id: UUID = UUID(), customer: Customer, quickBooksID: String? = nil, lineItemSummary: String = "", amount: Double = 0, status: String = "pending", notes: String? = nil, createdAt: Date = Date()) {
        self.id = id
