...
- QuickBooks Management is staged into Overview, Sales, Expenses, and Payments workspaces. Connection and sync health remain in Overview; customer/catalog/estimate/invoice work stays in Sales; vendor/bill/purchase work stays in Expenses; and payment-method/deposit/card operations stay in Payments. A persistent Sync action remains available without mixing all accounting resources into one long form.
