...
- Dispatch now considers equipment qualification, open capacity, weekly workload, configured city/ZIP/territory cues, and dispatcher-managed breaks, training, time off, and unavailable periods. Territory matching is advisory and never claims live GPS, traffic, or route optimization.
